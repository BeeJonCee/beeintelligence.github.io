  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <div className="bg-graphite-black text-pure-white py-4 px-4">
        <div className="container mx-auto flex items-center justify-between">
          <div className="flex items-center space-x-4">
            ...
            <h1 className="text-lg font-semibold">Restaurant Elegant Template</h1>
          </div>
      ...
      <div className="p-4">
        <div className="max-w-7xl mx-auto">
          <div className="bg-pure-white rounded-lg shadow-2xl overflow-hidden">
            <iframe
              src="/templates/restaurant/index.html"
      ...
      <div className="fixed bottom-4 right-4 bg-graphite-black/90 backdrop-blur-sm text-pure-white p-4 rounded-lg max-w-sm">
        <h3 className="font-semibold mb-2">Restaurant Elegant</h3>
        <p className="text-sm text-off-white/80 mb-3">
          Elegant restaurant template with menu showcase and reservation system.
        </p>
        <div className="flex flex-wrap gap-2 mb-3">
          <span className="px-2 py-1 bg-bee-yellow/20 text-bee-yellow text-xs rounded-full">Menu Showcase</span>
          <span className="px-2 py-1 bg-bee-yellow/20 text-bee-yellow text-xs rounded-full">Reservations</span>
          <span className="px-2 py-1 bg-bee-yellow/20 text-bee-yellow text-xs rounded-full">Gallery</span>
          <span className="px-2 py-1 bg-bee-yellow/20 text-bee-yellow text-xs rounded-full">Reviews</span>
        </div>
